  ...
  const projects = [
    {
      ...
      year: "2025",
      status: "Completed",
      description: "Full-stack real-time bus tracking system for USM campus with mobile app, live location visualization, ETA calculations, and admin dashboard.",
      techStack: ["React Native", "TypeScript", "Express.js", "Firestore", "Google Maps API"],
      features: [
    ...
    },
    {
      ...
      year: "2025",
      status: "Completed",
      description: "Comparative sentiment analysis for gaming/entertainment brands analyzing 400+ Facebook comments using advanced data mining techniques.",
    ...
    },
    {
      ...
      year: "2024",
      status: "Completed",
      description: "Full-stack web platform for student hostel registration with room selection, check-in/check-out management, and approval system.",
    ...
    },
    {
      ...
      year: "2023",
      status: "Completed",
      description: "Lightweight discussion platform created to solve communication challenges in university chess tournament.",
    ...
    },
    {
      ...
      year: "2022",
      status: "Completed",
      description: "Platform for private EV charging station sharing with decentralized charging network and booking mechanism.",
      ...
      impact: "Addressed national EV charger shortage with community-driven solution",
    ...
    },
    {
      ...
      year: "2021",
      status: "Completed",
      description: "Desktop hospital billing management system with strong focus on OOP principles and modular architecture.",
      ...
      impact: "Mastered OOP principles: encapsulation, inheritance, polymorphism",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            A showcase of my development journey from 2019 to 2025, featuring full-stack applications, 
              ...
              <div className="lg:flex">
                ...
                <div className="lg:w-1/3 p-8">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <span className="text-sm text-teal-400 font-medium">{project.year}</span>
                  ...
                  <div className="flex space-x-3">
                    <button className="flex items-center space-x-2 bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg transition-colors duration-200">
